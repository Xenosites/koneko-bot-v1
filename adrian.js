...
module.exports = conn = async (conn, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = [botNumber, ...global.owner, '6281255104397@s.whatsapp.net'].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
newReply(`*「  ᴇɢᴠᴜᴀxʀʟ ꜱᴄʀɪᴘᴛ  」*\n\n*YouTube:*\n*https://youtube.com/@xenosites*\n\n*Dont forget to donate yeah* 🍜 `)
        break
